...
export default function SwapComponent(props) {
    const [coin, setCoin] = useState(["ETH", "USDT"]);
    ...
    const getSwapEstimateAmountTo = async (val) => {
        ...
        if (props.contract !== null) {
            try {
                ...
                const res = BigInt(estimateOfAmountTo) / BigInt(PRECISION)
                await setAmountTo(res);
    ...
    const getSwapEstimateAmountFrm = async (val) => {
        ...
        if (props.contract !== null) {
            try {
                ...
                await setAmountFrom(BigInt(estimateOfAmountFrm) / BigInt(PRECISION));
            } catch (err) {
                alert(err?.data?.message);
            }
        }
